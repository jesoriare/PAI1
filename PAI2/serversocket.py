...
# -----------------------------
def main():
    # Contexto TLS del servidor (TLS 1.3)
    ...
    # Cipher suites robustas para TLS 1.3
    try:
        contexto_tls.set_ciphersuites(
            "TLS_AES_256_GCM_SHA384:TLS_CHACHA20_POLY1305_SHA256:TLS_AES_128_GCM_SHA256"
        )
    except AttributeError:
        # set_ciphersuites no existe en versiones antiguas; continuar con defaults seguros
        pass
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as servidor:
        ...
        logging.info(f"Arrancando servidor TLS en {HOST}:{PORT}")
